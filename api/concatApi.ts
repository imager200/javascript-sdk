...
import { ConcatRequest } from '../model/concatRequest';
...
export enum ConcatApiApiKeys {
    ApiKeyAuth,
}

export class ConcatApi {
    ...
    public setApiKey(key: ConcatApiApiKeys, value: string) {
        (this.authentications as any)[ConcatApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async concatAsyncPost (payload: ConcatRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/concat';
        ...
        if (payload === null || payload === undefined) {
            throw new Error('Required parameter payload was null or undefined when calling concatAsyncPost.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(payload, "ConcatRequest")
        };
     ...
     * @param payload request
     */
    public async concatSyncPost (payload: ConcatRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/concat/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'payload' is not null or undefined
        if (payload === null || payload === undefined) {
            throw new Error('Required parameter payload was null or undefined when calling concatSyncPost.');
        }

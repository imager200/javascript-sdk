...
export class CropApi {
    ...
    public setApiKey(key: CropApiApiKeys, value: string) {
        (this.authentications as any)[CropApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param x0 the x coordinate of the first point of the rectangle to crop.
     * @param x1 the x coordinate of the second point of the rectangle to crop.
     * @param y0 the y coordinate of the first point of the rectangle to crop.
     * @param y1 the y coordinate of the second point of the rectangle to crop.
     */
    public async cropAsyncGet (url: string, x0: number, x1: number, y0: number, y1: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/crop';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling cropAsyncGet.');
        }

        // verify required parameter 'x0' is not null or undefined
        if (x0 === null || x0 === undefined) {
            throw new Error('Required parameter x0 was null or undefined when calling cropAsyncGet.');
        }

        // verify required parameter 'x1' is not null or undefined
        if (x1 === null || x1 === undefined) {
            throw new Error('Required parameter x1 was null or undefined when calling cropAsyncGet.');
        }

        // verify required parameter 'y0' is not null or undefined
        if (y0 === null || y0 === undefined) {
            throw new Error('Required parameter y0 was null or undefined when calling cropAsyncGet.');
        }

        // verify required parameter 'y1' is not null or undefined
        if (y1 === null || y1 === undefined) {
            throw new Error('Required parameter y1 was null or undefined when calling cropAsyncGet.');
        }
     ...
     */
    public async cropAsyncPost (x0: number, x1: number, y0: number, y1: number, body: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/crop';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'x0' is not null or undefined
        if (x0 === null || x0 === undefined) {
            throw new Error('Required parameter x0 was null or undefined when calling cropAsyncPost.');
        }

        // verify required parameter 'x1' is not null or undefined
        if (x1 === null || x1 === undefined) {
            throw new Error('Required parameter x1 was null or undefined when calling cropAsyncPost.');
        }

        // verify required parameter 'y0' is not null or undefined
        if (y0 === null || y0 === undefined) {
            throw new Error('Required parameter y0 was null or undefined when calling cropAsyncPost.');
        }

        // verify required parameter 'y1' is not null or undefined
        if (y1 === null || y1 === undefined) {
            throw new Error('Required parameter y1 was null or undefined when calling cropAsyncPost.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling cropAsyncPost.');
        }
     ...
     * @param y1 the y coordinate of the second point of the rectangle to crop.
     */
    public async cropSyncGet (url: string, x0: number, x1: number, y0: number, y1: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/crop/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling cropSyncGet.');
        }

        // verify required parameter 'x0' is not null or undefined
        if (x0 === null || x0 === undefined) {
            throw new Error('Required parameter x0 was null or undefined when calling cropSyncGet.');
        }

        // verify required parameter 'x1' is not null or undefined
        if (x1 === null || x1 === undefined) {
            throw new Error('Required parameter x1 was null or undefined when calling cropSyncGet.');
        }

        // verify required parameter 'y0' is not null or undefined
        if (y0 === null || y0 === undefined) {
            throw new Error('Required parameter y0 was null or undefined when calling cropSyncGet.');
        }

        // verify required parameter 'y1' is not null or undefined
        if (y1 === null || y1 === undefined) {
            throw new Error('Required parameter y1 was null or undefined when calling cropSyncGet.');
        }
     ...
     * @param body image binary data, acceptable formats: jpeg,png,bmp,gif
     */
    public async cropSyncPost (x0: number, x1: number, y0: number, y1: number, body: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/crop/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/gif', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'x0' is not null or undefined
        if (x0 === null || x0 === undefined) {
            throw new Error('Required parameter x0 was null or undefined when calling cropSyncPost.');
        }

        // verify required parameter 'x1' is not null or undefined
        if (x1 === null || x1 === undefined) {
            throw new Error('Required parameter x1 was null or undefined when calling cropSyncPost.');
        }

        // verify required parameter 'y0' is not null or undefined
        if (y0 === null || y0 === undefined) {
            throw new Error('Required parameter y0 was null or undefined when calling cropSyncPost.');
        }

        // verify required parameter 'y1' is not null or undefined
        if (y1 === null || y1 === undefined) {
            throw new Error('Required parameter y1 was null or undefined when calling cropSyncPost.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling cropSyncPost.');
        }

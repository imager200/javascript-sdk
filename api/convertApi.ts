...
export class ConvertApi {
    ...
    public setApiKey(key: ConvertApiApiKeys, value: string) {
        (this.authentications as any)[ConvertApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param targetFormat 
     */
    public async convertAsyncGet (url: string, targetFormat?: 'jpeg' | 'png' | 'bmp' | 'ico' | 'gif', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/convert';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling convertAsyncGet.');
        }
        ...
        if (targetFormat !== undefined) {
            localVarQueryParameters['targetFormat'] = ObjectSerializer.serialize(targetFormat, "'jpeg' | 'png' | 'bmp' | 'ico' | 'gif'");
        }
     ...
     * @param targetFormat 
     */
    public async convertAsyncPost (body: RequestFile, targetFormat?: 'jpeg' | 'png' | 'bmp' | 'ico' | 'gif', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/convert';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling convertAsyncPost.');
        }
     ...
     * @param targetFormat 
     */
    public async convertSyncGet (url: string, targetFormat?: 'jpeg' | 'png' | 'bmp' | 'ico' | 'gif', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/convert/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling convertSyncGet.');
        }
     ...
     * @param targetFormat 
     */
    public async convertSyncPost (body: RequestFile, targetFormat?: 'jpeg' | 'png' | 'bmp' | 'ico' | 'gif', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/convert/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/gif', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling convertSyncPost.');
        }

...
export class ResizeApi {
    ...
    public setApiKey(key: ResizeApiApiKeys, value: string) {
        (this.authentications as any)[ResizeApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param height 
     * @param width 
     * @param resamplingAlgorithm It allows changing the resampling algorithm used when resizing (resampling) the image.
     */
    public async resizeAsyncGet (url: string, height: number, width: number, resamplingAlgorithm?: 'lanczos' | 'linear' | 'box' | 'nearest_neighbor' | 'catmull_rom', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/resize';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling resizeAsyncGet.');
        }

        // verify required parameter 'height' is not null or undefined
        if (height === null || height === undefined) {
            throw new Error('Required parameter height was null or undefined when calling resizeAsyncGet.');
        }

        // verify required parameter 'width' is not null or undefined
        if (width === null || width === undefined) {
            throw new Error('Required parameter width was null or undefined when calling resizeAsyncGet.');
        }
        ...
        if (resamplingAlgorithm !== undefined) {
            localVarQueryParameters['resamplingAlgorithm'] = ObjectSerializer.serialize(resamplingAlgorithm, "'lanczos' | 'linear' | 'box' | 'nearest_neighbor' | 'catmull_rom'");
        }
     ...
     * @param resamplingAlgorithm It allows changing the resampling algorithm used when resizing (resampling) the image.
     */
    public async resizeAsyncPost (height: number, width: number, body: RequestFile, resamplingAlgorithm?: 'lanczos' | 'linear' | 'box' | 'nearest_neighbor' | 'catmull_rom', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/resize';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'height' is not null or undefined
        if (height === null || height === undefined) {
            throw new Error('Required parameter height was null or undefined when calling resizeAsyncPost.');
        }

        // verify required parameter 'width' is not null or undefined
        if (width === null || width === undefined) {
            throw new Error('Required parameter width was null or undefined when calling resizeAsyncPost.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling resizeAsyncPost.');
        }
     ...
     * @param resamplingAlgorithm It allows changing the resampling algorithm used when resizing (resampling) the image.
     */
    public async resizeSyncGet (url: string, height: number, width: number, resamplingAlgorithm?: 'lanczos' | 'linear' | 'box' | 'nearest_neighbor' | 'catmull_rom', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/resize/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling resizeSyncGet.');
        }

        // verify required parameter 'height' is not null or undefined
        if (height === null || height === undefined) {
            throw new Error('Required parameter height was null or undefined when calling resizeSyncGet.');
        }

        // verify required parameter 'width' is not null or undefined
        if (width === null || width === undefined) {
            throw new Error('Required parameter width was null or undefined when calling resizeSyncGet.');
        }
     ...
     * @param resamplingAlgorithm It allows changing the resampling algorithm used when resizing (resampling) the image.
     */
    public async resizeSyncPost (height: number, width: number, body: RequestFile, resamplingAlgorithm?: 'lanczos' | 'linear' | 'box' | 'nearest_neighbor' | 'catmull_rom', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/resize/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/gif', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'height' is not null or undefined
        if (height === null || height === undefined) {
            throw new Error('Required parameter height was null or undefined when calling resizeSyncPost.');
        }

        // verify required parameter 'width' is not null or undefined
        if (width === null || width === undefined) {
            throw new Error('Required parameter width was null or undefined when calling resizeSyncPost.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling resizeSyncPost.');
        }

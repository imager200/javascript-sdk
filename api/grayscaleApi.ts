...
export enum GrayscaleApiApiKeys {
    ApiKeyAuth,
}

export class GrayscaleApi {
    ...
    public setApiKey(key: GrayscaleApiApiKeys, value: string) {
        (this.authentications as any)[GrayscaleApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async grayscaleAsyncGet (url: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/grayscale';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling grayscaleAsyncGet.');
        }
     ...
     */
    public async grayscaleAsyncPost (body: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/grayscale';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling grayscaleAsyncPost.');
        }
     ...
     * @param url image url, supported formats jpeg,png,bmp,gif
     */
    public async grayscaleSyncGet (url: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/grayscale/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling grayscaleSyncGet.');
        }
     ...
     * @param body image binary data, acceptable formats: jpeg,png,bmp,gif
     */
    public async grayscaleSyncPost (body: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/grayscale/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/gif', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling grayscaleSyncPost.');
        }

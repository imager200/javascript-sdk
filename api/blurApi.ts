...
export enum BlurApiApiKeys {
    ApiKeyAuth,
}

export class BlurApi {
    ...
    public setApiKey(key: BlurApiApiKeys, value: string) {
        (this.authentications as any)[BlurApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async blurAsyncGet (url: string, sigma?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/blur';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling blurAsyncGet.');
        }
     ...
     * @param sigma controls the strength of the blur
     */
    public async blurAsyncPost (body: RequestFile, sigma?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/blur';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling blurAsyncPost.');
        }
     ...
     * @param sigma controls the strength of the blur
     */
    public async blurSyncGet (url: string, sigma?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/blur/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling blurSyncGet.');
        }
     ...
     * @param sigma controls the strength of the blur
     */
    public async blurSyncPost (body: RequestFile, sigma?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/blur/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling blurSyncPost.');
        }

...
export enum RotateApiApiKeys {
    ApiKeyAuth,
}

export class RotateApi {
    ...
    public setApiKey(key: RotateApiApiKeys, value: string) {
        (this.authentications as any)[RotateApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param backgroundColor the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.
     */
    public async rotateAsyncGet (url: string, angle?: number, backgroundColor?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/rotate';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling rotateAsyncGet.');
        }
        ...
        if (angle !== undefined) {
            localVarQueryParameters['angle'] = ObjectSerializer.serialize(angle, "number");
        }
     ...
     * @param backgroundColor the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.
     */
    public async rotateAsyncPost (body: RequestFile, angle?: number, backgroundColor?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/rotate';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling rotateAsyncPost.');
        }
     ...
     * @param backgroundColor the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.
     */
    public async rotateSyncGet (url: string, angle?: number, backgroundColor?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/rotate/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling rotateSyncGet.');
        }
     ...
     * @param backgroundColor the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code.
     */
    public async rotateSyncPost (body: RequestFile, angle?: number, backgroundColor?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/rotate/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/gif', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling rotateSyncPost.');
        }

...
import { BlendRequest } from '../model/blendRequest';
...
export class BlendApi {
    ...
    public setApiKey(key: BlendApiApiKeys, value: string) {
        (this.authentications as any)[BlendApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async blendAsyncPost (payload: BlendRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/blend';
        ...
        if (payload === null || payload === undefined) {
            throw new Error('Required parameter payload was null or undefined when calling blendAsyncPost.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(payload, "BlendRequest")
        };
     ...
     * @param payload request
     */
    public async blendSyncPost (payload: BlendRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/blend/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'payload' is not null or undefined
        if (payload === null || payload === undefined) {
            throw new Error('Required parameter payload was null or undefined when calling blendSyncPost.');
        }

...
export enum CompressApiApiKeys {
    ApiKeyAuth,
}
...
export class CompressApi {
    ...
    public setApiKey(key: CompressApiApiKeys, value: string) {
        (this.authentications as any)[CompressApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param url image url, supported formats jpeg,png
     * @param jpegQuality defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)
     * @param pngOptimizationLevel defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.
     * @param progressiveJpeg It toggles the generation of a progressive JPEG. A \&quot;false\&quot; value generates a baseline JPEG
     */
    public async compressAsyncGet (url: string, jpegQuality?: number, pngOptimizationLevel?: number, progressiveJpeg?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/compress';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling compressAsyncGet.');
        }
        ...
        if (jpegQuality !== undefined) {
            localVarQueryParameters['jpegQuality'] = ObjectSerializer.serialize(jpegQuality, "number");
        }

        if (pngOptimizationLevel !== undefined) {
            localVarQueryParameters['pngOptimizationLevel'] = ObjectSerializer.serialize(pngOptimizationLevel, "number");
        }

        if (progressiveJpeg !== undefined) {
            localVarQueryParameters['progressiveJpeg'] = ObjectSerializer.serialize(progressiveJpeg, "boolean");
        }
    ...
    /**
     * This endpoint compresses the image according to the parameters.
     * @param body image binary data, acceptable formats: jpeg,png
     * @param jpegQuality defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains)
     * @param pngOptimizationLevel defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png.
     * @param progressiveJpeg It toggles the generation of a progressive JPEG. A \&quot;false\&quot; value generates a baseline JPEG
     */
    public async compressAsyncPost (body: RequestFile, jpegQuality?: number, pngOptimizationLevel?: number, progressiveJpeg?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/compress';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling compressAsyncPost.');
        }
     ...
     * @param progressiveJpeg It toggles the generation of a progressive JPEG. A \&quot;false\&quot; value generates a baseline JPEG
     */
    public async compressSyncGet (url: string, jpegQuality?: number, pngOptimizationLevel?: number, progressiveJpeg?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/compress/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/jpeg', 'image/png', 'application/json'];
        // give precedence to 'application/json'
        if (produces.indexOf('application/json') >= 0) {
            localVarHeaderParams.Accept = 'application/json';
        } else {
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling compressSyncGet.');
        }
     ...
     * @param progressiveJpeg It toggles the generation of a progressive JPEG. A \&quot;false\&quot; value generates a baseline JPEG
     */
    public async compressSyncPost (body: RequestFile, jpegQuality?: number, pngOptimizationLevel?: number, progressiveJpeg?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/compress/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling compressSyncPost.');
        }

...
export class TextApi {
     ...
     */
    public async textAsyncGet (url: string, text: string, color?: string, font?: string, size?: number, x?: number, y?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/text';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling textAsyncGet.');
        }

        // verify required parameter 'text' is not null or undefined
        if (text === null || text === undefined) {
            throw new Error('Required parameter text was null or undefined when calling textAsyncGet.');
        }
        ...
        if (color !== undefined) {
            localVarQueryParameters['color'] = ObjectSerializer.serialize(color, "string");
        }

        if (font !== undefined) {
            localVarQueryParameters['font'] = ObjectSerializer.serialize(font, "string");
        }
     ...
     * @param y the y coordinate in pixels of the point where the text will be added.
     */
    public async textAsyncPost (text: string, body: RequestFile, color?: string, font?: string, size?: number, x?: number, y?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/text';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'text' is not null or undefined
        if (text === null || text === undefined) {
            throw new Error('Required parameter text was null or undefined when calling textAsyncPost.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling textAsyncPost.');
        }
     ...
     * @param y the y coordinate in pixels of the point where the text will be added.
     */
    public async textSyncGet (url: string, text: string, color?: string, font?: string, size?: number, x?: number, y?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/text/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling textSyncGet.');
        }

        // verify required parameter 'text' is not null or undefined
        if (text === null || text === undefined) {
            throw new Error('Required parameter text was null or undefined when calling textSyncGet.');
        }
     ...
     * @param y the y coordinate in pixels of the point where the text will be added.
     */
    public async textSyncPost (text: string, body: RequestFile, color?: string, font?: string, size?: number, x?: number, y?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/text/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/gif', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'text' is not null or undefined
        if (text === null || text === undefined) {
            throw new Error('Required parameter text was null or undefined when calling textSyncPost.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling textSyncPost.');
        }

...
export enum BlurpartialApiApiKeys {
    ApiKeyAuth,
}

export class BlurpartialApi {
    ...
    public setApiKey(key: BlurpartialApiApiKeys, value: string) {
        (this.authentications as any)[BlurpartialApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param url image url, supported formats jpeg,png,bmp
     * @param x0 defines the x coordinate of the first point of the rectangle to blur
     * @param x1 defines the x coordinate of the second point of the rectangle to blur
     * @param y0 defines the y coordinate of the first point of the rectangle to blur
     * @param y1 defines the y coordinate of the second point of the rectangle to blur.
     * @param sigma controls the strength of the blur
     */
    public async blurpartialAsyncGet (url: string, x0: number, x1: number, y0: number, y1: number, sigma?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/blurpartial';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling blurpartialAsyncGet.');
        }

        // verify required parameter 'x0' is not null or undefined
        if (x0 === null || x0 === undefined) {
            throw new Error('Required parameter x0 was null or undefined when calling blurpartialAsyncGet.');
        }

        // verify required parameter 'x1' is not null or undefined
        if (x1 === null || x1 === undefined) {
            throw new Error('Required parameter x1 was null or undefined when calling blurpartialAsyncGet.');
        }

        // verify required parameter 'y0' is not null or undefined
        if (y0 === null || y0 === undefined) {
            throw new Error('Required parameter y0 was null or undefined when calling blurpartialAsyncGet.');
        }

        // verify required parameter 'y1' is not null or undefined
        if (y1 === null || y1 === undefined) {
            throw new Error('Required parameter y1 was null or undefined when calling blurpartialAsyncGet.');
        }
        ...
        if (sigma !== undefined) {
            localVarQueryParameters['sigma'] = ObjectSerializer.serialize(sigma, "number");
        }

        if (x0 !== undefined) {
            localVarQueryParameters['x0'] = ObjectSerializer.serialize(x0, "number");
        }

        if (x1 !== undefined) {
            localVarQueryParameters['x1'] = ObjectSerializer.serialize(x1, "number");
        }

        if (y0 !== undefined) {
            localVarQueryParameters['y0'] = ObjectSerializer.serialize(y0, "number");
        }

        if (y1 !== undefined) {
            localVarQueryParameters['y1'] = ObjectSerializer.serialize(y1, "number");
        }
     ...
     * @param y0 defines the y coordinate of the first point of the rectangle to blur
     * @param y1 defines the y coordinate of the second point of the rectangle to blur.
     * @param body image binary data, acceptable formats: jpeg,png,bmp
     * @param sigma controls the strength of the blur
     */
    public async blurpartialAsyncPost (x0: number, x1: number, y0: number, y1: number, body: RequestFile, sigma?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/blurpartial';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'x0' is not null or undefined
        if (x0 === null || x0 === undefined) {
            throw new Error('Required parameter x0 was null or undefined when calling blurpartialAsyncPost.');
        }

        // verify required parameter 'x1' is not null or undefined
        if (x1 === null || x1 === undefined) {
            throw new Error('Required parameter x1 was null or undefined when calling blurpartialAsyncPost.');
        }

        // verify required parameter 'y0' is not null or undefined
        if (y0 === null || y0 === undefined) {
            throw new Error('Required parameter y0 was null or undefined when calling blurpartialAsyncPost.');
        }

        // verify required parameter 'y1' is not null or undefined
        if (y1 === null || y1 === undefined) {
            throw new Error('Required parameter y1 was null or undefined when calling blurpartialAsyncPost.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling blurpartialAsyncPost.');
        }
     ...
     * @param sigma controls the strength of the blur
     */
    public async blurpartialSyncGet (url: string, x0: number, x1: number, y0: number, y1: number, sigma?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/blurpartial/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/jpeg', 'image/png', 'application/json'];
        // give precedence to 'application/json'
        if (produces.indexOf('application/json') >= 0) {
            localVarHeaderParams.Accept = 'application/json';
        } else {
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling blurpartialSyncGet.');
        }

        // verify required parameter 'x0' is not null or undefined
        if (x0 === null || x0 === undefined) {
            throw new Error('Required parameter x0 was null or undefined when calling blurpartialSyncGet.');
        }

        // verify required parameter 'x1' is not null or undefined
        if (x1 === null || x1 === undefined) {
            throw new Error('Required parameter x1 was null or undefined when calling blurpartialSyncGet.');
        }

        // verify required parameter 'y0' is not null or undefined
        if (y0 === null || y0 === undefined) {
            throw new Error('Required parameter y0 was null or undefined when calling blurpartialSyncGet.');
        }

        // verify required parameter 'y1' is not null or undefined
        if (y1 === null || y1 === undefined) {
            throw new Error('Required parameter y1 was null or undefined when calling blurpartialSyncGet.');
        }
     ...
     * @param sigma controls the strength of the blur
     */
    public async blurpartialSyncPost (x0: number, x1: number, y0: number, y1: number, body: RequestFile, sigma?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/blurpartial/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'x0' is not null or undefined
        if (x0 === null || x0 === undefined) {
            throw new Error('Required parameter x0 was null or undefined when calling blurpartialSyncPost.');
        }

        // verify required parameter 'x1' is not null or undefined
        if (x1 === null || x1 === undefined) {
            throw new Error('Required parameter x1 was null or undefined when calling blurpartialSyncPost.');
        }

        // verify required parameter 'y0' is not null or undefined
        if (y0 === null || y0 === undefined) {
            throw new Error('Required parameter y0 was null or undefined when calling blurpartialSyncPost.');
        }

        // verify required parameter 'y1' is not null or undefined
        if (y1 === null || y1 === undefined) {
            throw new Error('Required parameter y1 was null or undefined when calling blurpartialSyncPost.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling blurpartialSyncPost.');
        }

...
export enum ContrastApiApiKeys {
    ApiKeyAuth,
}

export class ContrastApi {
    ...
    public setApiKey(key: ContrastApiApiKeys, value: string) {
        (this.authentications as any)[ContrastApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async contrastAsyncGet (url: string, percentage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/contrast';
        ...
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling contrastAsyncGet.');
        }
     ...
     * @param percentage controls the contrast level
     */
    public async contrastAsyncPost (body: RequestFile, percentage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InfoResponse;  }> {
        const localVarPath = this.basePath + '/contrast';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling contrastAsyncPost.');
        }
     ...
     * @param percentage controls the contrast level
     */
    public async contrastSyncGet (url: string, percentage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/contrast/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new Error('Required parameter url was null or undefined when calling contrastSyncGet.');
        }
     ...
     * @param percentage controls the contrast level
     */
    public async contrastSyncPost (body: RequestFile, percentage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        const localVarPath = this.basePath + '/contrast/sync';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['image/bmp', 'image/gif', 'image/jpeg', 'image/png', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling contrastSyncPost.');
        }

...
export class ConcatRequest {
    ...
    */
    'concatMode'?: ConcatRequest.ConcatModeEnum = ConcatRequest.ConcatModeEnum.None;
    /**
    ...
    */
    'direction'?: ConcatRequest.DirectionEnum = ConcatRequest.DirectionEnum.Hor;
    'image1'?: string;
    'image2'?: string;
    'targetFormat'?: ConcatRequest.TargetFormatEnum = ConcatRequest.TargetFormatEnum.Jpeg;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "concatMode",
            "baseName": "concatMode",
            "type": "ConcatRequest.ConcatModeEnum"
        },
        {
            "name": "direction",
            "baseName": "direction",
            "type": "ConcatRequest.DirectionEnum"
        },
        {
            "name": "image1",
            "baseName": "image1",
        ...
        },
        {
            ...
            "type": "ConcatRequest.TargetFormatEnum"
        }    ];

    static getAttributeTypeMap() {
        return ConcatRequest.attributeTypeMap;
    }
}

export namespace ConcatRequest {
    export enum ConcatModeEnum {
        None = <any> 'none',
        Rts = <any> 'rts',
        Rtl = <any> 'rtl'
    }

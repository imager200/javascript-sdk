...
export class BlendRequest {
    'alpha'?: number;
    'image1': string;
    'image2': string;
    'mode'?: BlendRequest.ModeEnum = BlendRequest.ModeEnum.Rts;
    'targetFormat'?: BlendRequest.TargetFormatEnum = BlendRequest.TargetFormatEnum.Jpeg;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "mode",
            "baseName": "mode",
            "type": "BlendRequest.ModeEnum"
        },
        {
            "name": "targetFormat",
            "baseName": "targetFormat",
            "type": "BlendRequest.TargetFormatEnum"
        }    ];

    static getAttributeTypeMap() {
        return BlendRequest.attributeTypeMap;
    }
}

export namespace BlendRequest {
